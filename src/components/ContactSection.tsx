...
import { Phone, MessageSquare, Clock, MapPin, Check, Send, Sparkles, HelpCircle } from "lucide-react";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-stretch">
          ...
          <div className="lg:col-span-5 space-y-6 flex flex-col justify-between">
            ...
            <div className="bg-white p-6 sm:p-8 rounded-3xl border border-zinc-150 shadow-sm space-y-6">
              ...
              {/* SMS messaging item */}
              <div className="flex items-start gap-4">
                <div className="p-3 bg-sky-50 rounded-xl text-sky-600 shrink-0 mt-0.5">
                  <Send className="w-5 h-5" />
                </div>
                <div>
                  <p className="font-mono text-[10px] uppercase font-bold text-zinc-400 tracking-wider">SMS / Text Message</p>
                  <a
                    href={businessInfo.smsUrl}
                    className="font-sans font-extrabold text-base text-zinc-900 hover:text-sky-600 transition-colors block mt-0.5"
                    id="contact-sms-btn"
                  >
                    sms:+91 86391 21227
                  </a>
                  <p className="text-xs text-zinc-500 font-sans">Send direct inquiries via standard cellular text</p>
                </div>
              </div>
